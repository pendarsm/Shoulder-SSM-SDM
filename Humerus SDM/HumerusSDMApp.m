classdef HumerusSDMApp < handle
    ...
    properties (Constant)
        AppPathBase = {'/HumerusSDM'};
        AppClass = 'HumerusSDMApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            HumerusSDMApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'Main_Humerus_SDM')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong Main_Humerus_SDM
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'Main_Humerus_SDM').getString, ...
            ...
            if nargout(@Main_Humerus_SDM) == 0
                eval('Main_Humerus_SDM');
            else
                obj.AppHandle = eval('Main_Humerus_SDM');
            end
