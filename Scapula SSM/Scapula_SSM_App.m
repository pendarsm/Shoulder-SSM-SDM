classdef Scapula_SSM_App < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.PC1ScoreEditFieldLabel.Position = [23 306 70 22];
            ...
            app.PC1ScoreEditField.Position = [103 306 50 22];
            ...
            app.Slider_1.Position = [173 316 109 3];
            ...
            app.CreateOutputFileButton.Position = [252 22 137 24];
            ...
            app.PC2ScoreEditFieldLabel.Position = [23 256 70 22];
            ...
            app.PC2ScoreEditField.Position = [103 256 50 22];
            ...
            app.Slider_2.Position = [173 266 109 3];
            ...
            app.PC3ScoreEditFieldLabel.Position = [23 206 70 22];
            ...
            app.PC3ScoreEditField.Position = [103 206 50 22];
            ...
            app.Slider_3.Position = [173 216 109 3];
            ...
            app.PC4ScoreEditFieldLabel.Position = [23 156 70 22];
            ...
            app.PC4ScoreEditField.Position = [103 156 50 22];
            ...
            app.Slider_4.Position = [173 166 109 3];
            ...
            app.PC5ScoreEditFieldLabel.Position = [23 106 70 22];
            ...
            app.PC5ScoreEditField.Position = [103 106 50 22];
            ...
            app.Slider_5.Position = [173 116 109 3];
            ...
            app.PC6ScoreEditFieldLabel.Position = [353 306 70 22];
            ...
            app.PC6ScoreEditField.Position = [433 306 50 22];
            ...
            app.Slider_6.Position = [503 316 109 3];
            ...
            app.PC7ScoreEditFieldLabel.Position = [353 256 70 22];
            ...
            app.PC7ScoreEditField.Position = [433 256 50 22];
            ...
            app.PC8ScoreEditField.Position = [433 206 50 22];
            ...
            app.Slider_8.Position = [503 216 109 3];
            ...
            app.PC9ScoreEditFieldLabel.Position = [353 156 70 22];
            ...
            app.PC9ScoreEditField.Position = [433 156 50 22];
            ...
            app.Slider_9.Position = [503 166 109 3];
            ...
            app.TextArea.Position = [1 382 640 65];
