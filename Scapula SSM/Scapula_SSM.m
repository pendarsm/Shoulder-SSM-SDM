...
%input vector (modes of variation) should be described by perturbing the mean shape by +/- desired standard deviations (e.g. +1 standard deviation) for each of the first 9 (significant) principal components (PCs).
