classdef ScapulaSSMApp < handle
    ...
    properties (Constant)
        AppPathBase = {'/ScapulaSSM'};
        AppClass = 'ScapulaSSMApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            ScapulaSSMApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'Main_Scapula_SSM')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong Main_Scapula_SSM
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'Main_Scapula_SSM').getString, ...
            ...
            if nargout(@Main_Scapula_SSM) == 0
                eval('Main_Scapula_SSM');
            else
                obj.AppHandle = eval('Main_Scapula_SSM');
            end
