classdef ScapulaSDMApp < handle
    ...
    properties (Constant)
        AppPathBase = {'/ScapulaSDM'};
        AppClass = 'ScapulaSDMApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            ScapulaSDMApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'Main_Scapula_SDM')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong Main_Scapula_SDM
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'Main_Scapula_SDM').getString, ...
            ...
            if nargout(@Main_Scapula_SDM) == 0
                eval('Main_Scapula_SDM');
            else
                obj.AppHandle = eval('Main_Scapula_SDM');
            end
